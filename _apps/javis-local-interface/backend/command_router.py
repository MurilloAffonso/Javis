...
RULES: list[tuple[str, list[str]]] = [
    ...
    ("atualizar_memoria", ["atualiza a memória", "atualiza a memoria",
                        "atualizar a memória", "atualizar memória", "atualiza memória",
                        "atualiza memoria", "atualizar memoria",
                        "atualiza as notas", "atualizar as notas", "atualiza minhas notas",
                        "atualiza o conhecimento", "atualizar conhecimento",
                        "reindexar", "reindexa", "re-indexar", "re-indexa",
                        "indexar as notas", "indexar notas",
                        "recarrega a memória", "recarregar memória", "recarrega as notas",
                        "sincroniza a memória", "sincronizar memória", "sincroniza as notas",
                        "lê as notas de novo", "le as notas de novo"]),
    ("clima",          ["clima", "tempo hoje", "que tempo", "temperatura", "vai chover",
                        "tá chovendo", "ta chovendo", "previsão do tempo", "previsao do tempo",
                        "faz calor", "tá frio", "ta frio", "graus"]),
    ("analisar_site",  ["analisa o site", "analisar site", "analise o site",
                        "copia o site", "copiar site", "clona o site", "clonar site",
                        "recria o site", "recriar site", "analisa esse site",
                        "olha esse site", "analisa essa página", "analisar página"]),
    ...
    ("trocar_motor",   ["usa o codex", "usar o codex", "usa codex", "muda pro codex",
                        "mudar pro codex", "troca pro codex", "motor codex",
                        "passa pro codex", "vai de codex", "liga o codex",
                        "usa o claude", "usar o claude", "usa claude", "muda pro claude",
                        "mudar pro claude", "troca pro claude", "motor claude",
                        "passa pro claude", "vai de claude", "liga o claude",
                        "trocar de motor", "trocar o motor", "troca o motor",
                        "qual motor", "que motor"]),
...
RISK_MAP = {
    ...
    "clima":          ("low",      False),
    "hora_data":      ("low",      False),
    "trocar_motor":   ("low",      False),
    "atualizar_memoria": ("low",   False),
    "conversa":       ("none",     False),
...
ACTION_MAP = {
    ...
    "clima":           "weather",
    "hora_data":       "get_time",
    "trocar_motor":    "switch_brain",
    "atualizar_memoria": "reindex_memory",
...
def _reason(intent: str, text: str) -> str:
    reasons = {
        ...
        "atualizar_memoria": "pedido de reindexar a memória/notas detectado",
