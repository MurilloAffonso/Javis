# Plano de SEO e Visibilidade Digital - Vem Passear Jampa

Plano operacional para colocar a Vem Passear Jampa na frente de turistas que pesquisam passeios em João Pessoa, com prioridade para Google Maps, Google Business Profile, Instagram, WhatsApp Business, diretórios locais e conteúdo de cauda longa.

Contexto usado:

- Operação: Vem Passear Jampa, operada por Murillo em João Pessoa/PB.
- Venda atual: WhatsApp e Instagram, sem site próprio ativo.
- Produtos: Piscinas Naturais do Seixas, Picãozinho, Litoral Norte, Combo Duplo Seixas + Picãozinho e Passeio Infantil.
- Posicionamento editorial: guia local confiável, visual, caloroso, consultivo, com promessa realista sobre maré, clima, segurança e experiência.
- Agentes: Midas monitora crescimento, busca, conversão e reviews; Nova adapta conteúdo, legendas, ganchos e linguagem criativa.

Observação sobre dados: volumes e dificuldades de palavras-chave abaixo são estimativas práticas para priorização inicial. Midas deve validar depois em Google Trends, Ubersuggest, Planejador de Palavras-chave, Google Search Console e termos do Google Business Profile.
...
- Aparecer no Google Maps para buscas locais de alta intenção.
- Transformar avaliações em prova social visível antes do cliente chamar no WhatsApp.
- Usar fotos reais dos passeios para competir com empresas maiores.
- Criar conteúdo de cauda longa no YouTube, GBP e Google Sites sem depender de site profissional.
- Converter pesquisas com urgência: turista em João Pessoa querendo passeio nos próximos 1 a 3 dias.

### Riscos

- Concorrentes com GBP completo, reviews e fotos recentes aparecem antes.
- Instagram sozinho não captura bem quem pesquisa no Google.
- WhatsApp sem catálogo claro gera repetição de perguntas e perda de leads.
- Falta de páginas indexáveis limita ranqueamento para termos específicos.
- Marca fica dependente de algoritmo social, indicação e tráfego pago.

### 5 principais gaps de SEO nessa situação
...
|---:|---|---|---|---|---|---|
| 1 | passeio João Pessoa | Alta | Transacional | Alto | Difícil | Não |
| 2 | passeios em João Pessoa | Alta | Transacional | Alto | Difícil | Não |
| 3 | piscinas naturais João Pessoa | Alta | Transacional | Alto | Difícil | Não |
| 4 | passeio de barco João Pessoa | Alta | Transacional | Médio | Médio | Sim |
| 5 | piscinas naturais do Seixas | Alta | Transacional | Médio | Médio | Sim |
| 6 | passeio Piscinas do Seixas | Alta | Transacional | Médio | Médio | Sim |
| 7 | passeio Picãozinho João Pessoa | Alta | Transacional | Médio | Médio | Sim |
| 8 | passeio litoral norte João Pessoa | Alta | Transacional | Médio | Médio | Sim |
| 9 | passeio de catamara João Pessoa | Alta | Transacional | Médio | Médio | Não |
| 10 | passeio infantil João Pessoa | Alta | Transacional | Baixo | Fácil | Sim |
| 11 | combo passeio João Pessoa | Média | Transacional | Baixo | Fácil | Sim |
| 12 | passeio barato João Pessoa | Média | Transacional | Médio | Médio | Não |
| 13 | reservar passeio João Pessoa | Média | Transacional | Baixo | Fácil | Sim |
| 14 | melhor passeio em João Pessoa | Média | Informacional/transacional | Médio | Médio | Não |
| 15 | o que fazer em João Pessoa | Média | Informacional | Alto | Difícil | Não |
| 16 | roteiro João Pessoa 3 dias | Média | Informacional | Médio | Médio | Não |
| 17 | piscinas naturais João Pessoa maré | Média | Informacional | Médio | Médio | Sim |
| 18 | melhor maré piscinas naturais João Pessoa | Média | Informacional | Baixo | Fácil | Sim |
| 19 | Seixas ou Picãozinho qual melhor | Média | Informacional | Baixo | Fácil | Sim |
| 20 | Picãozinho vale a pena | Média | Informacional | Baixo | Fácil | Sim |
| 21 | Seixas vale a pena | Média | Informacional | Baixo | Fácil | Sim |
...
| 30 | Vem Passear Jampa | Alta | Navegacional | Baixo | Fácil | Sim |

### 5 quick wins principais

1. "passeio de barco João Pessoa" - alta intenção, menos amplo que "passeio João Pessoa".
2. "Piscinas do Seixas" - termo de destino específico, bom para fotos, reviews e GBP.
3. "passeio Picãozinho João Pessoa" - comprador já sabe o destino e procura fornecedor.
4. "melhor maré piscinas naturais João Pessoa" - dúvida que Nova pode transformar em Reels, GBP update e YouTube.
5. "passeio infantil João Pessoa" - oferta específica com menos concorrência e apelo familiar.

### Como usar as palavras-chave sem spam

- GBP: usar nas descrições de serviços, posts e respostas a perguntas.
- Instagram: usar 1 palavra-chave na primeira linha da legenda e 1 no alt text.
- WhatsApp Business: usar nos nomes dos itens de catálogo.
- YouTube: colocar palavra-chave no título, primeira frase da descrição e tags.
- Micro-blog: criar uma página por passeio e uma página de FAQ de maré.
...
1. Criar ou reivindicar o perfil em `business.google.com`.
2. Validar propriedade do negócio pelo metodo indicado pelo Google.
3. Padronizar o nome: `Vem Passear Jampa`.
4. Preencher telefone/WhatsApp principal, cidade, área de atendimento e link de contato.
5. Escolher categoria principal mais específica disponível.
6. Cadastrar todos os serviços com preço inicial, descrição e foto.
7. Subir logo, capa, fotos de passeio e vídeos curtos.
8. Criar link/QR code de avaliação.
9. Publicar 2 posts por semana.
10. Revisar insights toda segunda-feira.

### Categoria principal recomendada

Escolher no painel a categoria mais específica disponível, nesta ordem:

1. Operadora de turismo.
2. Agência de passeios turísticos.
...
Regra: pedir review somente de cliente real, sem incentivo, desconto, brinde ou promessa em troca de avaliação.

Fluxo ideal:

1. Durante o passeio, Murillo ou equipe avisa que a opiniao ajuda turistas a escolherem com segurança.
2. Ao final, enviar mensagem pelo WhatsApp com link curto de avaliação.
3. No dia seguinte, enviar lembrete leve somente se o cliente respondeu positivamente ou demonstrou satisfacao.
4. Responder todos os reviews em ate 48 horas.
...
```text
Oi, [nome]! Passando só para deixar de novo o link da avaliação da Vem Passear Jampa:
[link]

Se tiver 1 minutinho, sua opiniao ajuda muito quem esta procurando passeio em João Pessoa. Obrigado!
```

### Posts no GBP

Frequencia mínima: 2 posts por semana.

Frequencia ideal em alta temporada: 3 posts por semana.
...
```text
[Nome], muito obrigado pelo carinho! Que bom que você aproveitou as piscinas naturais em João Pessoa com a gente. A Vem Passear Jampa trabalha para orientar cada cliente sobre maré, horário e melhor passeio para a data da viagem. Esperamos ver você de novo por aqui!
```
...
Resposta quando ha problema operacional:

```text
[Nome], obrigado por compartilhar sua experiência. Sentimos muito que o passeio não tenha atendido sua expectativa. Vamos revisar internamente o ponto citado para melhorar nosso atendimento. Se puder, chame a gente pelo WhatsApp para entendermos melhor o ocorrido e buscarmos uma solução adequada.
```
...
| Metrica | Meta 90 dias | Como interpretar |
|---|---:|---|
...
Nome de exibição ideal:

- `Passeios João Pessoa | Vem Passear Jampa`

Alternativas:

- `Piscinas Naturais JP | Vem Passear`
- `Passeios em João Pessoa - Vem Passear`
...
```text
Passeios em João Pessoa PB
Seixas, Picãozinho e Litoral Norte
Maré, vagas e reservas no WhatsApp
Clique e mande sua data
```

Modelo com preço claro:

```text
Passeios em João Pessoa PB
Seixas R$65 | Picãozinho R$75
Litoral Norte | Combos | Familias
...
A gente te orienta pela maré certa
Seixas, Picãozinho e Litoral Norte
Chame no WhatsApp
```
...
```text
Oi! Quero saber as vagas e o melhor passeio em João Pessoa para minha data. Vou estar em João Pessoa de __/__/__ a __/__/__.
```

### Alt text para fotos

Usar descrições naturais, sem empilhar palavras-chave.
...
### Palavras-chave nas legendas

Padrao recomendado:

1. Primeira linha com termo principal e gancho.
2. Corpo com informação útil.
3. CTA para WhatsApp com palavra de atendimento.
4. Hashtags em 6 a 12 termos, sem bloco exagerado.

Exemplo:

```text
Piscinas naturais em João Pessoa dependem da maré certa.
...
| Hashtag | Uso |
|---|---|
| #JoaoPessoa | Base local ampla |
| #JoaoPessoaPB | Base local qualificada |
| #Jampa | Local e coloquial |
| #TurismoJoaoPessoa | Turismo local |
| #PasseiosEmJoaoPessoa | Intenção comercial |
| #PasseioJoaoPessoa | Intenção comercial |
| #PiscinasNaturaisJoaoPessoa | Produto principal |
| #PiscinasDoSeixas | Produto específico |
| #Seixas | Produto/local |
| #Picãozinho | Produto específico |
| #LitoralNortePB | Produto específico |
| #PraiasDaParaiba | Descoberta regional |
...
| Hashtag | Uso |
|---|---|
| #ReelsBrasil | Reels com apelo amplo |
| #ReelsDeViagem | Video de viagem |
| #POVViagem | Formato POV |
| #DicaDePasseio | Conteúdo educativo |
| #RoteiroJoaoPessoa | Planejamento local |
| #MareBaixa | Educativo |
| #PasseioDeBarco | Produto |
| #Catamara | Quando aplicavel |
| #FotosDeViagem | Desejo visual |
| #VemPassearJampa | Marca |
| #BoraPraJampa | Marca/comunidade |
| #JampaComMareCerta | Campanha própria |
...
Padrao de publicação:

- Frequencia: 5 Reels por semana.
- Horarios prioritarios: 7h30-9h, 12h-13h30, 19h-21h. Testar por 30 dias.
- Titulo na tela nos 2 primeiros segundos.
- Palavra-chave na primeira linha da legenda.
- Capa com termo legivel: "Seixas", "Picãozinho", "Maré", "Passeio em JP".
- CTA final curto.

Exemplos de títulos:

- "Piscinas naturais em João Pessoa: veja a maré"
- "Seixas ou Picãozinho: qual escolher?"
- "Passeio de barco em João Pessoa por R$65"
- "3 erros antes de reservar piscinas naturais"
- "Passeio infantil em João Pessoa: como funciona"
...
- Usar ponto de atendimento ou área de serviço apenas se for real e consistente com GBP.
...
- 1 foto principal forte por passeio.
- Sem arte poluida.
- Nome do arquivo organizado para a equipe: `seixas-piscinas-naturais-joao-pessoa.jpg`.
- Atualizar mensalmente com fotos melhores.

### Mensagem automatica de saudacao

```text
Oi! Seja bem-vindo(a) a Vem Passear Jampa 🌊

A gente organiza passeios em João Pessoa para Seixas, Picãozinho, Litoral Norte, combos e famílias.

Para te indicar o melhor passeio pela maré, me envie:
1. Data da sua viagem
2. Quantas pessoas
3. Se tem criança
4. Qual passeio você quer conhecer
```

### Mensagem de ausência

```text
Oi! Obrigado por chamar a Vem Passear Jampa.

Agora estamos fora do horário de atendimento, mas sua mensagem já ficou aqui. Assim que voltarmos, vamos te responder com vagas, horários e melhor opção de passeio em João Pessoa para sua data.

Se quiser adiantar, envie sua data de viagem, quantidade de pessoas e se deseja Seixas, Picãozinho, Litoral Norte ou combo.
```
...
| Atalho | Mensagem |
|---|---|
| `/maré` | Para piscinas naturais, a maré faz muita diferença. Me envie sua data em João Pessoa que eu verifico as melhores opções de horário e passeio. |
| `/valores` | Valores atuais: Seixas R$65, Picãozinho R$75, Litoral Norte R$90 adulto, Combo Seixas + Picãozinho R$120, Infantil R$40. Posso verificar vagas para sua data? |
| `/criança` | Temos opção para famílias com crianças. Me diga a idade da criança e a data da viagem para eu orientar o passeio mais tranquilo. |
...
```text
https://wa.me/55DDDNUMERO?text=Oi%21%20Quero%20saber%20vagas%20e%20melhor%20passeio%20em%20Joao%20Pessoa%20para%20minha%20data.
```

Mensagem ideal:

```text
Oi! Quero saber vagas e o melhor passeio em João Pessoa para minha data. Estarei em JP de __/__/__ a __/__/__. Somos __ pessoas.
```

---

## 6. Estratégia de link building local gratuito

Objetivo: aumentar presenca da marca, criar citações locais consistentes e gerar sinais de autoridade para o Google. Todos os cadastros devem usar o mesmo NAP:
...
### 10 diretórios/portais prioritarios

| Prioridade | Portal | Tipo | O que preencher |
|---:|---|---|---|
| 1 | Google Business Profile | Mapa/local | Perfil completo, serviços, fotos, reviews, posts e link WhatsApp |
| 2 | Cadastur | Credibilidade oficial | Cadastro de prestador turístico, dados completos e categoria correta |
...
| 10 | GuiaMais / Apontador | Diretorio local | Nome, telefone, cidade, categoria turismo e descrição com palavras-chave |
...
### Como criar perfil em cada um

Checklist padrão:

1. Criar conta com e-mail operacional.
2. Verificar se já existe perfil duplicado.
3. Reivindicar ou criar perfil novo.
4. Inserir NAP exatamente igual ao GBP.
5. Usar descrição curta de 250 caracteres e descrição longa de 750 a 1.000 caracteres.
6. Subir logo, capa e pelo menos 10 fotos.
7. Cadastrar serviços/produtos individualmente.
8. Colocar link de reserva/WhatsApp.
...
- Pagina ou post "parceiros recomendados".
- Comissao por reserva indicada, se operacionalmente valido.
- QR code do WhatsApp no balcao.
- Conteúdo útil para o hospede: "Como escolher passeio pela maré".
- Repost de conteúdo do hotel/pousada quando fizer sentido.

Template de abordagem para hotel/pousada:
...
### Abordagem para blogueiros/influenciadores locais
...
| # | Titulo SEO | Palavra-chave principal | Formato |
|---:|---|---|---|
| 1 | Piscinas naturais em João Pessoa: como escolher o melhor dia pela maré | piscinas naturais João Pessoa maré | Educativo |
| 2 | Seixas ou Picãozinho: qual passeio escolher em João Pessoa? | Seixas ou Picãozinho | Comparativo |
| 3 | Passeio de barco em João Pessoa: quanto custa e como reservar | passeio de barco João Pessoa | Guia prático |
...
- Colocar palavra-chave nos primeiros 60 caracteres.
...
- Seixas: R$65
- Picãozinho: R$75
- Litoral Norte: R$90 adulto
- Combo Seixas + Picãozinho: R$120
...
Palavras-chave: passeio em João Pessoa, piscinas naturais João Pessoa, passeio de barco João Pessoa, Seixas João Pessoa, Picãozinho João Pessoa.
```

Tags:

- passeio joao pessoa
- piscinas naturais joao pessoa
- passeio de barco joao pessoa
- piscinas do seixas
- picaozinho joao pessoa
- turismo paraiba
- litoral norte paraiba
...
1. Abrir com melhor imagem do destino.
2. Dizer em 5 segundos o que o vídeo responde.
3. Mostrar o passeio real.
4. Explicar maré, preço, duração e reserva.
5. Fechar com CTA para WhatsApp.
...
- Notion público: rápido para publicar, bom para guias, mas menos forte como estrutura comercial.
- Linktree Pro/Beacons: bom para link da bio, fraco como blog SEO.
- Medium: pode ranquear artigos, mas menos controle comercial.
- YouTube: melhor para conteúdo visual e pesquisas de cauda longa.

### 5 artigos curtos para GBP Updates

1. Como escolher o melhor dia para piscinas naturais em João Pessoa.
...
## 8. Calendário de SEO - 90 dias

### Mes 1 - Fundacao

Objetivo: criar base local confiável, rastreavel e pronta para converter.
...
| 3 | Cadastrar Bing Places e Apple Business Connect | Midas | Dois perfis locais criados |
| 3 | Criar ou revisar Facebook Page | Nova | Pagina com botao WhatsApp e fotos |
...
| Semana | Ação | Responsavel | Entrega |
|---:|---|---|---|
| 5 | Criar Google Sites simples | Midas | Home + páginas de Seixas, Picãozinho, Litoral Norte e contato |
...
- 2 a 4 vídeos YouTube.
- Google Sites indexável no ar.
- Instagram com highlights completos.

### Mes 3 - Crescimento

Objetivo: ganhar autoridade local, links, reviews e aprendizado comercial.

| Semana | Ação | Responsavel | Entrega |
|---:|---|---|---|
| 9 | Abordar 10 hoteis/pousadas | Murillo/Midas | Lista de contatos, mensagens e retornos |
| 9 | Cadastrar Viator/GetYourGuide/Civitatis se fizer sentido operacional | Midas | Avaliacao de elegibilidade e custos |
| 10 | Publicar 3 vídeos YouTube adicionais | Nova | Comparativo, infantil, Litoral Norte |
| 10 | Subir 20 fotos novas no GBP | Nova | Fotos recentes de clientes/destinos |
...
- 100+ fotos no GBP.
- 6 a 8 vídeos YouTube.
- 10+ citações locais/diretórios.
- Entrar no top 5 do Maps para pelo menos 2 termos de intenção media/alta em áreas próximas da orla.
...
| Instagram | Seguidores qualificados | +15% a +25% em 90 dias |
| Instagram | Cliques no link/WhatsApp | Crescimento mensal de 20% |
| WhatsApp | Conversas iniciadas | Medir por origem: Google, Instagram, indicação |
| WhatsApp | Taxa de conversão | Meta inicial: 20% a 35% dos leads qualificados |
| YouTube | Videos publicados | 6 a 8 |
| YouTube | Cliques para WhatsApp | Medir por link rastreavel |

### Ferramentas gratuitas

- Google Business Profile Performance: principal painel de Maps, Search, chamadas, rotas, cliques e termos de busca.
- Google Search Console: usar quando o Google Sites ou site próprio estiver no ar.
- Instagram Insights: alcance, retencao, compartilhamentos, salvamentos e cliques no link.
- Ubersuggest free: validacao básica de palavras-chave e dificuldade.
- Google Trends: sazonalidade de "João Pessoa", "piscinas naturais", "Picãozinho".
- Bitly ou Short.io: links rastreaveis para WhatsApp por canal.
- Planilha interna: registrar leads, origem, passeio, data, valor, status e observacoes.
...
- Leads por origem.
- Conteudos com mais WhatsApp.

Mensal:

- Ranking manual no Google Maps por termo.
- Termos de busca do GBP.
- Conversao WhatsApp por origem.
- Crescimento de avaliações.
- Paginas ou vídeos que mais geraram cliques.

Trimestral:

- Repriorizar palavras-chave.
- Atualizar descrições de serviços.
- Ajustar categorias se o painel oferecer opções mais específicas.
- Revisar metas de reviews e fotos.
- Decidir se vale criar site próprio com dominio.

### O que ajustar por sinal
...
1. Pesquisar manualmente ou via busca web controlada:
   - "passeio João Pessoa"
   - "passeio de barco João Pessoa"
   - "piscinas naturais João Pessoa"
   - "Piscinas do Seixas"
   - "Picãozinho João Pessoa"
2. Registrar:
   - Posição aproximada da Vem Passear Jampa.
   - Concorrentes que aparecem.
   - Quantidade de reviews dos concorrentes.
   - Tipo de foto de capa usada pelos primeiros colocados.
   - Termos usados nos títulos/descrições.
...
Reviews da Vem Passear Jampa:
Reviews do top 3:
Ação recomendada para GBP:
Ação recomendada para Instagram:
Ação recomendada para WhatsApp:
```

### Nova - legendas e SEO criativo

Nova deve transformar cada pauta em:

- Gancho de 3 segundos.
- Legenda com palavra-chave natural.
- Alt text.
- Hashtags por camada.
- CTA para WhatsApp.
- Versao curta para GBP.
- Versao curta para Stories.
...
O Javis pode ser programado para monitorar:

- "Vem Passear Jampa"
- "Vem Passear JP"
- "Murillo passeio João Pessoa"
- Marcacoes no Instagram.
- Reviews novos no Google.
- Comentarios com dúvidas recorrentes.
- Concorrentes subindo no Maps.

Alertas úteis:

- Review negativo novo.
- Review positivo sem resposta após 24 horas.
- Queda de posição em termo prioritario.
- Concorrente novo no top 3.
- Aumento de buscas por "maré" ou "Picãozinho".

### Script de coleta de avaliações pos-passeio

Fluxo recomendado:

1. Murillo registra lista de clientes do dia com nome, telefone, passeio e status.
2. Midas gera mensagens personalizadas de review.
3. Murillo aprova o envio ou envia manualmente.
4. Javis registra status: enviado, respondeu, avaliou, sem resposta.
5. Após 48 horas, Midas sugere lembrete leve apenas para quem pode receber contato.
...
| Telefone | +55... |
| Passeio | Picãozinho |
| Origem | Instagram / Google / Indicacao |
| Mensagem review enviada | Sim/Não |
| Review recebido | Sim/Não |
| Nota | 5 |
| Observação | Citou atendimento e maré |
...
### Automacoes seguras para os próximos 90 dias
